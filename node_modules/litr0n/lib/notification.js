class Notification {
	...
	confirm($element, message, callback) {
		...
		var template = '' + '<div class="popover popover-confirm" role="tooltip">' + '<div class="arrow"></div>' + '<h3 class="popover-title"></h3>' + '<div class="popover-content"></div>' + '<div id="' + uid + '" class="confirm">' + '<button class="yes bootstrap-button btn btn-primary">Sí</button>' + '<button class="no bootstrap-button btn btn-primary">No</button>' + '</div>' + '</div>';
